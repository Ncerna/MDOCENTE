...
<div class='col-lg-12' style='border-color: #f5c6cb;' id="tutotiales_Id">
    <div id='user_avisomanual' class='alert  sm' role='alert' style='color: #0e0102; background-color: #acefe4;'><button
        ...
        Para crear un nuevo usuario pues dirigiste a las siguiente vista solo da clik en. Gracias!!. &nbsp;<span
            class='label label-info'><em class="fa fa-plus"></em></span>&nbsp; Para activar o desactivar usuarios da
        clik en <span class='label label-defult'><em class="fa fa-eye"></em></span>

    </div>
</div>

<div class='col-lg-12' style='border-color: #f5c6cb; display: none' id='cret_avisomanual'>
    <div class='alert  sm' role='alert' style='color: #0e0102; background-color: #acefe4;'><button type="button"
        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="remove" title=""
                    data-original-title="Remove" onclick="Limpiar_Registrar_Usuario()">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="col-md-4">
                        ...
                        <div class="alin_global">
                            ...
                            </select>&nbsp;&nbsp;<button onclick="Estraer_Datos_Docentes();" class="btn-sm"
                                id="but_alin_global" disabled>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="alin_global">
                            ...
                            </select>&nbsp;&nbsp;<button onclick="Estraer_Datos_Alumno();" class="btn-sm"
                                id="but_alin_global">
                                <em class="fa fa-search"></em>
                            </button>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="alin_global">
                            <select class="js-example-basic-single" name="state" id="cbm_otros" style="width:100%;">
                                <option value="">NO SE ENCONTRARON REGISTROS</option>
                            </select>&nbsp;&nbsp;<button onclick="Estraer_Datos_Otros();" class="btn-sm"
                                id="but_alin_global" disabled>
                                <em class="fa fa-search"></em>
                            </button>
                        </div>
             ...
             (event. charCode > 31 && event.charCode < 33)"><br>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="txt_apellido" placeholder="Ingrese nombre"
             ...
             (event. charCode > 31 && event.charCode < 33)"><br>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="txt_usuario"
                            placeholder="ejemplo:admin@.com/usuaroDEV125"
                    ...
                    <div class="col-md-6">
                       ...
                       (event. charCode > 96 && event.charCode < 123)||(event. charCode >34 && event.charCode<39)||(event. charCode>47 && event. charCode<58)||(event. charCode==42)">
                                <span class="input-group-btn">&nbsp;&nbsp;
                                    <button onclick="mostrarPassword()" type="button" class="btn btn-secondary"><em
                                            id="iconoeyes" class="fa fa-eye-slash"></em></button></span>
                            </div>
                            &nbsp;&nbsp;
